...
public class ProceduralGenerationAlgorithms
{
    ...
    public static List<BoundsInt> BinarySpacePartitioning(BoundsInt spaceToSplit, int minWidth, int minHeight)
    {
        ...
        while (roomsQueue.Count > 0)
        {
            ...
            if (room.size.x >= minWidth * 2 && room.size.x >= minWidth * 2)
            {
                SplitRoom(minHeight, minWidth, roomsQueue, room);
            } else if (room.size.x >= minWidth && room.size.x >= minWidth) {
                roomsList.Add(room);
            }
        }
    ...
    private static void SplitRoom(int minWidth, int minHeight, Queue<BoundsInt> roomsQueue, BoundsInt room)
    {
...
public static class Direction2D
{
    ...
    public static Vector2Int rightDown = new Vector2Int(1, -1);
    public static Vector2Int down = new Vector2Int(0, -1);
    public static Vector2Int downLeft = new Vector2Int(-1, -1);
    public static Vector2Int left = new Vector2Int(-1, 0);
    public static Vector2Int leftUp = new Vector2Int(-1, 1);
